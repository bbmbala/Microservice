package com.bala.reviems.review;

import com.bala.reviems.review.messaging.ReviewMessageProducer;
...
public class ReviewController {
    ...
    public ResponseEntity<Double> averageRating(@RequestParam Long companyId){
        List<Review> reviews=reviewService.getAllReviews(companyId);
        Double avgReview=reviews.stream().mapToDouble(Review::getRating).average().orElse(0.0);
        return new ResponseEntity<>(avgReview,HttpStatus.OK);
    }
}
